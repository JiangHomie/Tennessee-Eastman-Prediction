...
from Proj_1.main_mask import GCNLSTM, MyDataset
...
if __name__ == '__main__':
    ...
    # 读取mask文件
    mask_path_list = ['m01.npy', 'm02.npy', 'm03.npy', 'm04.npy', 'm05.npy',
                      'm06.npy', 'm07.npy', 'm08.npy', 'm09.npy', 'm10.npy',
                      'm11.npy', 'm12.npy', 'm13.npy', 'm14.npy', 'm15.npy',
                      'm16.npy', 'm17.npy', 'm18.npy', 'm19.npy', 'm20.npy',
                      'm21.npy']
    # mask_path_list = ['m01.npy']
    mask_list = []
    for mp in mask_path_list:
        mk = np.load(os.path.join('masks/masks1', mp))
        mask_list.append(mk)
    ...
    with torch.no_grad():
        for i, (input, target) in enumerate(test_loader):
            ...
            input = input.squeeze()
            output_cls, output_abnorm = multi_model_vote(input, adj, mask_tensor)
